...
> **Navigation Hub** - Find everything in the sonotheia-examples repository
...
- [API Migration Guide](API_MIGRATION_GUIDE.md) - Version update guide
...
| [Enhanced Examples](ENHANCED_EXAMPLES.md) | Advanced patterns | Adding resilience features |
...
- **Kubernetes**: [kubernetes/](../examples/kubernetes/)
...
- **Webhooks**: [Node.js webhook-server.js](../examples/node/webhook-server.js)
- **Streaming**: [Python streaming_example.py](../examples/python/streaming_example.py)
