...
def split_audio_file(
    ...
    try:
        ...
        raise ImportError("This example requires ffmpeg. Install it with: apt-get install ffmpeg")
...
def process_streaming(
    ...
    with SonotheiaClientEnhanced(
        ...
        if results["summary"]["high_risk_chunks"] > 0:
            logger.info(f"Submitting SAR for {results['summary']['high_risk_chunks']} high-risk chunks")
            try:
