...
def mfa_verify():
    ...
    logger.info(f"MFA verification: verified={verified}, confidence={confidence:.3f}, enrollment={enrollment_id}")
...
def main():
    ...
    parser.add_argument('--api-key', default=None, help='Mock API key (default: mock_api_key_12345)')
