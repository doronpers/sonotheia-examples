...
# 3. Check types
mypy examples/python/ --ignore-missing-imports

# 4. Check YAML
yamllint .

# 5. Run all pre-commit hooks (final verification)
pre-commit run --all-files
```

## Common Issues & Fixes

### Missing Imports (mypy errors)
**Error**: `error: Name "APIRouter" is not defined`
